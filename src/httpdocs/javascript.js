...
vm.Core = (function() {
    ...
    return {
        ...
        swap: function(region, newView) {
            ...
            region.el.empty().html(newView.el);
        }
    };
})();
...
Settings.Model = Backbone.Model.extend({
    urlRoot: api_url+'model/bb_user?id=1',
    defaults: {
        company_name: null,
        first_name: null,
        last_name: null,
...
App.Routers.Main = Backbone.Router.extend({
    ...
    denied: function() {
        $('body #content').html('Zugriff verweigert!');
    }
});
