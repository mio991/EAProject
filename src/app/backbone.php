...
require_once realpath('backbone/bb_book.class.php');
require_once realpath('backbone/bb_books.class.php');
require_once realpath('backbone/bb_transaction.class.php');
